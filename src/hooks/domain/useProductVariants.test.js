...
import { useAdminProductVariants } from './useProductVariants';
...
describe('useProductVariants', () => {
  it('useAdminProductVariants retorna objeto con propiedades de useQuery', () => {
    const { result } = renderHook(() => useAdminProductVariants({}), { wrapper: makeWrapper() });
