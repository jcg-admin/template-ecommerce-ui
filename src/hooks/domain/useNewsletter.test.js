...
import { useNewsletterSubscribers } from './useNewsletter';
...
describe('useNewsletter', () => {
  it('useNewsletterSubscribers retorna objeto con propiedades de useQuery', () => {
    const { result } = renderHook(() => useNewsletterSubscribers({}), { wrapper: makeWrapper() });
