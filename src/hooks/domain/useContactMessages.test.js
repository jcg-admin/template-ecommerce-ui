...
import { useAdminContactMessages } from './useContactMessages';
...
describe('useContactMessages', () => {
  it('useAdminContactMessages retorna objeto con propiedades de useQuery', () => {
    const { result } = renderHook(() => useAdminContactMessages({}), { wrapper: makeWrapper() });
