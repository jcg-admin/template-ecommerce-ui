...
import { useProductQuestions } from './useProductQuestions';
...
describe('useProductQuestions', () => {
  it('useProductQuestions retorna objeto con propiedades de useQuery', () => {
    const { result } = renderHook(() => useProductQuestions({}), { wrapper: makeWrapper() });
