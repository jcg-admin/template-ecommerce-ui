...
describe('useRelatedProducts', () => {
  it('useRelatedProducts retorna objeto con propiedades de useQuery', () => {
    const { result } = renderHook(() => useRelatedProducts({}), { wrapper: makeWrapper() });
