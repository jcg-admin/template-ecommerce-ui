...
| [corregir-bugs-validacion-storefront](corregir-bugs-validacion-storefront/) | En ejecucion | Validacion en browser del storefront (post corregir-bugs-auditoria) | 13 bugs de integracion en runtime detectados validando los flujos del comprador (login, carrito, favoritos, busqueda, paginacion): race conditions, desajustes de contrato/estado, guards de auth y UX. Fixes F1-F5 en commits f572673..26dd600; F6 anade 19 tests de regresion (verificados red->green); F7 corrige BUG-SEARCH-04 (boton Reintentar no re-fetcheaba). Scope abierto a sucesivas pasadas. | |
