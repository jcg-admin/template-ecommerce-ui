...
| [adaptar-sistema-diseno-yoruba](adaptar-sistema-diseno-yoruba/) | En ejecucion | (raiz) | Paquete de referencia dist-yoruba-ui (8 versiones, 102 archivos): paleta del brazalete (verde lima + vino + bronce), tema oscuro, Fraunces + IBM Plex, componentes y paginas re-skinadas. Adaptacion selectiva por 7 fases (tokens, shape datos, componentes, storefront, cuenta, admin, cierre). 8 hallazgos criticos documentados. | |
