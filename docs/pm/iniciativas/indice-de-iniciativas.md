...
| [resolver-hallazgos-de-deuda-del-template](resolver-hallazgos-de-deuda-del-template/) | En ejecucion | (raiz) | Resolver hallazgos de deuda del template aplicables (H-01 a H-04, H-08), delegar 2 a iniciativas propias (H-05, H-07), retirar 13 historicos o duplicados. | |
