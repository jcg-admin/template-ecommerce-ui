...
| [adaptar-componentes-kno-react](adaptar-componentes-kno-react/) | En analisis | Solicitud usuario | Estudiar el repo de referencia NestorMonroy/-progress (paquetes kno-react-*, catalogo modelado sobre KendoReact) y adaptar de manera NATIVA al template los componentes con encaje ecommerce (galeria/scrollview, visor PDF, gantt de logistica, upload, etc.): codigo propio inspirado en su API/UX, sin importar el origen. 41 paquetes inventariados y mapeados; pendiente que el usuario priorice el subconjunto inicial. | |
