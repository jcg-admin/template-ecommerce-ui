...
| [validar-contrato-de-mocks-vs-backend-real](validar-contrato-de-mocks-vs-backend-real/) | En ejecucion | resolver-hallazgos-de-deuda-del-template (H-07) | Asegurar que los mocks de `src/mocks/` reflejen el contrato real del backend Django+DRF, mediante schema por endpoint o generacion desde OpenAPI. | |
