...
| [cablear-rutas-huerfanas](cablear-rutas-huerfanas/) | En analisis | Solicitud usuario (auditar rutas/UCs huerfanas) | De 102 rutas en AppRouter, 22 no tienen enlace en la UI (alcanzables solo por URL). Premise Gate 0b -> CONFIRMAR. Conecta cada huerfana a su punto de entrada (AccountSidebar 4, AdminSidebar 12, enlace desde pagina padre 6). Complementa auditar-rutas-y-flujos (que registro paginas sin ruta). |
