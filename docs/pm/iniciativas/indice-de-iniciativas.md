...
| [integrar-componentes-ui-core-js](integrar-componentes-ui-core-js/) | En ejecucion | Solicitud usuario (cierre de mapear-y-corregir-scss-completo) | Adaptar la logica de comportamiento y accesibilidad de los 29 componentes vanilla JS de ui-core-5.25.0 al stack React del template, mediante hooks y componentes funcionales propios. No se importan los JS de ui-core en produccion. | |
