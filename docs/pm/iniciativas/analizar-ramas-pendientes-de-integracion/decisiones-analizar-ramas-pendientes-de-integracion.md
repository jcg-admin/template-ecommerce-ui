...
| 6. Diagrama mermaid de topology + sequenceDiagram para listener | PASA | `analisis-ramas-pendientes-de-integracion.md` contiene un `gitGraph`. `analisis-rama-claude-resume-ecommerce-project.md` contiene un `sequenceDiagram` del flujo `py:unauthorized`. |
