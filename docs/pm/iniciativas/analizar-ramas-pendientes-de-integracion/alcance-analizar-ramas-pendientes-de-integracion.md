...
| Documentar el backend (`ecommerce-api`), la base (`ecommerce-db`) ni el servidor (`ecommerce-server`) | Cada uno tiene su propio repositorio y su propio modulo de gestion. |
